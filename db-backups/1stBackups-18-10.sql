...
Backup Time: 2023-10-18 09:52:31
*/
...
CREATE TABLE "absensi_sholats" (
  ...
  "tanggal_sholat" date NOT NULL DEFAULT '2023-10-15'::date,
...
CREATE TABLE "activities" (
  ...
  "decription" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
...
INSERT INTO "public"."banners" ("id","judul","deskripsi","cover","created_at","updated_at","kategori","status") VALUES (2, 'Tips n Trick Menghafal Alquran', 'Lorem ipsum dolor, sit amet. vero illum placeat itaque ratione porro unde debitis alias explicabo officiis ipsam sequi quae, consectetur quis! In tenetur amet quas facere, delectus facilis iusto temporibus vitae animi! Corrupti a quasi exercitationem ab voluptatum voluptate!', 'test123', '2023-10-15 04:50:26', '2023-10-15 04:50:26', 0, 'f'),(3, 'Tabligh Akbar Bersama Ustadz UAS', 'Lorem ipsum dolor, sit amet. vero illum placeat itaque ratione porro unde debitis alias explicabo officiis ipsam sequi quae, consectetur quis! In tenetur amet quas facere, delectus facilis iusto temporibus vitae animi! Corrupti a quasi exercitationem ab voluptatum voluptate!', 'test123', '2023-10-15 04:50:26', '2023-10-15 04:50:26', 2, 'f'),(1, 'Promo Al-Quran Tajdwid Lengkap Dics. up to 50%', 'Lorem ipsum dolor, sit amet. vero illum placeat itaque ratione porro unde debitis alias explicabo officiis ipsam sequi quae, consectetur quis! In tenetur amet quas facere, delectus facilis iusto temporibus vitae animi! Corrupti a quasi exercitationem ab voluptatum voluptate!', 'test123', '2023-10-15 04:50:26', '2023-10-15 04:50:26', 1, 't')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."data_ziswafs" IN SHARE MODE;
DELETE FROM "public"."data_ziswafs";
INSERT INTO "public"."data_ziswafs" ("id","users_id","masjid_id","jenis_ziswaf_id","no_rek","asal_bank","nominal","created_at","updated_at") VALUES (1, 1, 1, 1, 1234, 'Bank Mandiri', 10000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 1, 1, 2, 1234, 'Bank Mandiri', 10000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(3, 1, 1, 3, 1234, 'Bank Mandiri', 10000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(4, 1, 1, 4, 1234, 'Bank Mandiri', 10000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."education" IN SHARE MODE;
DELETE FROM "public"."education";
INSERT INTO "public"."education" ("id","jenis_education_id","judul","kategori","content","deskripsi","created_at","updated_at") VALUES (1, 2, 'Cara Menjadi Ayah yang Baik', 2, 'test123', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores blanditiis nostrum possimus a ab.Dolore omnis vero illum placeat itaque ratione porro unde debitis alias explicabo officiis ipsam.', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 2, 'Kisah Rasulallah Remaja', 1, 'test123', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores blanditiis nostrum possimus a ab.Dolore omnis vero illum placeat itaque ratione porro unde debitis alias explicabo officiis ipsam.', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(3, 1, 'Cara Mengaji dengan Baik', 0, 'test123', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores blanditiis nostrum possimus a ab.', '2023-10-15 04:50:26', '2023-10-15 04:50:26')
;
COMMIT;
BEGIN;
...
INSERT INTO "public"."lap_keus" ("id","masjid_id","cashflow","note","date","nominal","created_at","updated_at") VALUES (1, 1, 1, 'Beli Semen 2 Sak', '2023-10-15', 1000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 1, 0, 'Uang Kaleng', '2023-10-16', 500000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(3, 1, 0, 'Uang Kaleng', '2023-10-17', 700000, '2023-10-15 04:50:26', '2023-10-15 04:50:26')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."masjids" IN SHARE MODE;
DELETE FROM "public"."masjids";
INSERT INTO "public"."masjids" ("id","masjid_name","masjid_pict","alamat","ketua_masjid","kapasitas","saldo_awal","kas","created_at","updated_at") VALUES (1, 'An-Nisa', 'test123', 'Pesawaran, Lampung', 'Muhammad Fakhri', 500, 35000000, 35000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 'An-Nahl', 'test123', 'Bandar Lampung, Lampung', 'Ahmad Faridz', 1500, 8000000, 8000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(3, 'Al-Wasii', 'test123', 'Bandar Lampung, Lampung', 'Ahmad Al-Farizi', 700, 13000000, 13000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(4, 'Al-Muttaqin', 'test123', 'Palembang, Sumatera Selatan', 'Zikrullah', 1200, 10000000, 10000000, '2023-10-15 04:50:26', '2023-10-15 04:50:26')
;
COMMIT;
BEGIN;
...
INSERT INTO "public"."users" ("id","name","email","no_hp","profil_pict","password","status","remember_token","created_at","updated_at") VALUES (3, 'Syahril Fajri Pratama', 'syahril799@gmail.com', '081994854907', 'test123', 'qwerty123', 0, NULL, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(4, 'Ahmad Alfarizi', 'ahmadkun@gmail.com', '083499812234', 'test123', 'qwerty123', 0, NULL, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(1, 'Muhammad Faiz', 'faizgo@gmail.com', '081278781234', 'test123', 'qwerty123', 1, NULL, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 'Fadhil Fadhillah', 'ffadhil@gmail.com', '080056781234', 'test123', 'qwerty123', 1, NULL, '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(7, 'qwert', 'qwert@gmail.com', '081278789876', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:38:13', '2023-10-17 06:38:13'),(8, 'qwerty', 'qwerty@gmail.com', '081278789871', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:38:30', '2023-10-17 06:38:30'),(9, 'werty', 'werty@gmail.com', '08178789871', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:38:42', '2023-10-17 06:38:42'),(10, 'erty', 'erty@gmail.com', '0817879871', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:38:54', '2023-10-17 06:38:54'),(11, 'errty', 'errty@gmail.com', '08178798714', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:39:07', '2023-10-17 06:39:07'),(12, 'e1rrty', 'e1rrty@gmail.com', '08178798744', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:39:20', '2023-10-17 06:39:20'),(13, 'asdfghj', 'asdfghj@gmail.com', '08178792244', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:40:15', '2023-10-17 06:40:15'),(15, 'asdfgh', 'asdfhj@gmail.com', '08178792241', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:40:32', '2023-10-17 06:40:32'),(16, 'asdfgah', 'asdfahj@gmail.com', '08178792291', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:40:50', '2023-10-17 06:40:50'),(17, 'asdgah', 'adfahj@gmail.com', '08178792201', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:41:00', '2023-10-17 06:41:00'),(18, 'asdgaha', 'adfahaj@gmail.com', '081787922031', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:41:20', '2023-10-17 06:41:20'),(19, 'asdiiaha', 'adwhaj@gmail.com', '081780922031', 'test123', 'qwerty123', 0, NULL, '2023-10-17 06:41:37', '2023-10-17 06:41:37')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."waktu_sholats" IN SHARE MODE;
DELETE FROM "public"."waktu_sholats";
INSERT INTO "public"."waktu_sholats" ("id","nama_sholat","waktu_sholat","created_at","updated_at") VALUES (1, 'Subuh', '04:22:00', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(2, 'Dzuhur', '11:56:00', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(3, 'Ashar', '14:50:00', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(4, 'Mahgrib', '17:53:00', '2023-10-15 04:50:26', '2023-10-15 04:50:26'),(5, 'Isya', '19:01:00', '2023-10-15 04:50:26', '2023-10-15 04:50:26')
;
COMMIT;
...
SELECT setval('"waktu_sholats_id_seq"', 5, true);
